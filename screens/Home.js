...
export default Home = ({ navigation }) => {
  ...
  <View style={styles.avatarEmpty}>
    <Text style={styles.avatarEmptyText}>
      {profile && profile.firstName && Array.from(profile.firstName)[0]}
      {profile && profile.lastName && Array.from(profile.lastName)[0]}
    </Text>
  </View>
)}
      ...
      <View style={styles.heroSection}>
        ...
        <View style={styles.heroBody}>
          ...
          <Image
            ...
            accessible={true}
            accessibilityLabel={"Little Lemon Hero"}
          />
        </View>
        <Searchbar
          placeholder="Search"
